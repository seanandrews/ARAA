...
# set up plots
fig = plt.figure(figsize=(6.33, 2.9))
...
logM = db['logLs'][ok]
elogM = 0.5*(db['elogLs_H'][ok] + db['elogLs_L'][ok])
...
logMl = db['logLs'][ok]
elogMl = 0.5*(db['elogLs_H'][ok] + db['elogLs_L'][ok])
