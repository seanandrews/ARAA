...
# HRD
ntest = 15000
data_logT = np.load('outputs/'+name+'.logT.posterior.npz')['logT']
data_logL = np.load('outputs/'+name+'.logL.posterior.npz')['logL']
...
# overplot models
top_dir = '/pool/asha1/COMPLETED/Lupus_sizes/analysis/'
...
fig.savefig(name+'_hrd_inferences.pdf')
fig.clf()
